var snowStorm = (function(window, document) {
	...
	this.flakesMaxActive = 86;      // Limit amount of snow falling at once (less = lower CPU use)
	...
	this.snowColor = 'var(--color-gray-8)';        // Don't eat (or use?) yellow snow.
	this.snowShadow = '0 0 black';
	...
	opacitySupported = (function(){
		try {
			document.createElement('div').style.opacity = '0.4';
		} catch(e) {
			return false;
		}
		return true;
